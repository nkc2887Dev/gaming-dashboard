        ...
        <div className="p-2 bg-[#F0F8FF]">
          <div className="p-4 border border-dashed rounded-lg">
            ...
            <div className="flex flex-wrap items-center gap-4">
              <Label className="text-sm min-w-[140px] font-semibold">
                My Available
              </Label>
              <Input
                value="50"
                readOnly
                className="!bg-[#5DC9DB] text-black border border-gray-600 w-full max-w-[140px] text-center rounded-md"
              />
              <Input
                value="0"
                readOnly
            ...
            {/* Amount */}
            <div className="flex flex-wrap md:flex-row flex-col items-center gap-4 mt-4">
              <Label className="text-sm min-w-[140px] font-semibold">
                Amount
              </Label>
              <Input
                type="number"
                className="flex-1 w-full border border-gray-600 px-3 py-2 rounded-md"
              />
            </div>

            {/* Remarks */}
            <div className="flex flex-wrap md:flex-row flex-col items-start gap-4 mt-4">
              <Label className="text-sm min-w-[140px] font-semibold">
                Remarks
              </Label>
              <Textarea className="flex-1 w-full h-16 resize-none border border-gray-600 px-3 py-2 rounded-md" />
            </div>
          </div>
        </div>
